<template>
    ...
    <el-card class="mt">
        <el-button type="danger" :disabled="!selectionList.length" @click="batchDelete">批量删除</el-button>
    ...
    <el-card class="mt">
        <el-table :data="dataList" v-loading="loading" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="金额" prop="money" align="ringht" :formatter="formatDecimal"></el-table-column>
...
import { formatDecimal } from '@/utils/toThousands'
import { batchDeleteApi } from '@/api/operaions'
...
// 监听处理订单详情（TabsLayout的KeepAlive）跳转外其他都刷新
