    ...
    <div>
        ...
        <el-card class="mt">
            ...
            <el-table :data="tableData" v-loading="loading">
                ...
                <el-table-column label="充电站ID" prop="id" width="100" align="center"></el-table-column>
                <el-table-column label="所属城市" prop="city" width="80" align="center"></el-table-column>
                <el-table-column label="充电桩总量(个)" prop="count" align="right"
                    :formatter="formatInteger"></el-table-column>
                <el-table-column label="单日总收入(元)" prop="day" sortable align="right" :formatter="formatDecimal">
                ...
                <el-table-column label="月度总收入(万元)" prop="month" align="right" :formatter="formatDecimal">
                    <template #default="scope">
                ...
                <el-table-column label="电费营收(元)" prop="electricity" align="right"
                    :formatter="formatDecimal"></el-table-column>
                <el-table-column label="停车费营收(元)" prop="parkingFee" align="right"
                    :formatter="formatDecimal"></el-table-column>
                <el-table-column label="服务费营收(元)" prop="serviceFee" align="right"
                    :formatter="formatDecimal"></el-table-column>
                <el-table-column label="会员储值金(元)" prop="member" align="right"
                    :formatter="formatDecimal"></el-table-column>
            </el-table>
...
import { formatNumberToThousands, formatInteger, formatDecimal } from "@/utils/toThousands"
import { useCharts } from "@/hooks/useCharts";
import { onMounted } from "vue";
import { usePagination } from "@/hooks/usePaginaltion";
