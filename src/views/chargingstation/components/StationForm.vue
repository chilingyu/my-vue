<template>
    <el-dialog :model-value="dialogVisible" :title="title" width="80%" @close="handleClose" destroy-on-close>
            ...
            <el-row>
                ...
                <el-col :span="12">
                    ...
                    <el-form-item label="充电站状态：" prop="status">
                        <el-select v-model="ruleForm.status" placeholder="请选择充电站状态" :disabled="disabled">
